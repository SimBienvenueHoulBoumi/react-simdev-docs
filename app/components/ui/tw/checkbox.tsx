...
//
// `indeterminate` est une propriété DOM, pas un attribut : posez-la via une ref
// (`el.indeterminate = true`). Le trait est dessiné après la coche dans la liste
// de classes, donc il l'emporte quand les deux états coexistent.
  ...
  return (
    <input
      ...
      className={cn(
        ...
        "indeterminate:bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2016%2016%22%3E%3Cpath%20d=%22M4%208h8%22%20fill=%22none%22%20stroke=%22white%22%20stroke-width=%222%22%20stroke-linecap=%22round%22/%3E%3C/svg%3E')] indeterminate:bg-center indeterminate:bg-no-repeat",
